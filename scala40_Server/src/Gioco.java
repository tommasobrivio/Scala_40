...
public class Gioco extends Thread {
    ...
    /* costruttore */
    public Gioco(PlayerServer p1/* , PlayerServer p2 */, ServerTCP server) throws IOException {
        this.p1 = p1;
        // this.p2=p2;
        this.inGioco = p1;
        campo = new Campo();
    ...
    public void run() {
        ...
        try {
            ...
            server.send("gioco iniziato;", inGioco.socket);
            ...
            server.send(messaggio.output, p1.socket);
        ...
        try {
            ...
            server.send("gioco finito;", p1.socket);
    ...
    private void gestioneRichieste() throws IOException {
        ...
        switch (dati[1]) {
            ...
            case "passa":
                ...
                if (!inGioco.aperto) {
                    ...
                    /* altrimenti */
                        ...
                        Carta scarto = new Carta(datiCarta[0].charAt(0), datiCarta[1].charAt(0), datiCarta[2].charAt(0),
                                Integer.parseInt(datiCarta[3]));
            ...
            case "attacca":
                ...
                Carta attacca = new Carta(datiCarta[0].charAt(0), datiCarta[1].charAt(0), datiCarta[2].charAt(0),
                        Integer.parseInt(datiCarta[3]));
